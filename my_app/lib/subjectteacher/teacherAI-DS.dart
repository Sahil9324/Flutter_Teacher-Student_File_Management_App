...
// import 'dart:io';
//
// class TeacherAIDS extends StatelessWidget {
...
//     return SizedBox(
//       height: 400, // Define a fixed height for the TeacherAIDS widget
//       child: Scaffold(
//
//
//
...
//                         SizedBox(
//                           width: 150,
//                           child: Text(pickedFiles[index].path.split('/').last),
//                         ),
//                       ),
//                       DataCell(
//                         IconButton(
...
class TeacherAIDS extends StatelessWidget {
  ...
  Future<void> downloadFile(String fileName, BuildContext context) async {
    try {
      ...
      firebase_storage.FirebaseStorage.instance.ref('AI-DS/$fileName');
  ...
  Future<void> removeFileFromStorage(String fileName) async {
    try {
      await firebase_storage.FirebaseStorage.instance.ref('AI-DS/$fileName').delete();
